...
{
    public class CreateDoctorDtoValidator : CreateUserDtoValidator<CreateDoctorDto>
    {
        public CreateDoctorDtoValidator(IUserService userService, IPositionService positionService) : base(userService)
        {
